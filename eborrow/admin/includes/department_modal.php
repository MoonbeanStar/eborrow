    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-depname"><b>Add New Department</b></h4>
            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
              <h4 class="modal-depname"><b>Edit Department</b></h4>
            </div>
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="department_edit.php">
                ...
                <div class="form-group">
                    <label for="edit_depname" class="col-sm-3 control-label">Dept Name</label>

                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="edit_depname" name="depname">
                    </div>
                </div>
            </div>
            <div class="modal-footer">
