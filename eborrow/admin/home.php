      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              <?php
                $sql = "SELECT * FROM tbl_inventory WHERE dept ='mis' AND classification='mne'";
          ...
          <div class="small-box bg-purple">
            <div class="inner">
              <?php
                $sql = "SELECT * FROM tbl_inventory WHERE dept ='mis' AND classification='mne' and status = 0";
                $query = $conn2->query($sql);
            ...
            <a href="itemav.php" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              <?php
                $sql = "SELECT * FROM borrow WHERE date_return = '$today'";
                $query = $conn->query($sql);
...
<?php
  ...
  $borrow = array();
  for( $m = 1; $m <= 12; $m++ ) {
    $sql = "SELECT * FROM borrow WHERE MONTH(date_return) = '$m' AND YEAR(date_return) = '$year'";
