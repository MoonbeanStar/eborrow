          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered">
                ...
                <tbody>
                  <?php
                    $sql = "SELECT *, employees.id AS empid FROM employees LEFT JOIN department ON department.id=employees.department_id";
                      ...
                      echo "
                        <tr>
                          ...
                          <td>
                            ...
                            <a href='#edit_photo' data-toggle='modal' class='pull-right photo' data-id='".$row['empid']."'><span class='fa fa-edit'></span></a>
                          </td>
